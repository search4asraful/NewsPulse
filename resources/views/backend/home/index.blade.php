...
<main class="main-wrapper">
  ...
  <!--start switcher-->
    <button class="btn btn-primary position-fixed bottom-0 end-0 m-2 mb-5 d-flex align-items-center gap-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop">
